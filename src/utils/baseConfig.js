...
const DEFAULT_GLOBAL_BACKGROUND_CONFIG = {
    enabled: false,
    imageUrl: '',
    position: 'center',
    size: 'cover',
...
export const GLOBAL_BACKGROUND_CONFIG = mergeDeep(DEFAULT_GLOBAL_BACKGROUND_CONFIG, getConfig('GLOBAL_BACKGROUND_CONFIG'));
