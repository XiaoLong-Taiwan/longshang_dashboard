...
export const config  = {
    ...
    API_CONFIG: {
        ...
        staticBaseUrl: [
            'https://api.nylz.xyz/api/v1',
            'https://api.nylz.site/api/v1'
        ],
    ...
    SITE_CONFIG: {
        siteName: 'NYLZ 诺亚龙舟',
        siteDescription: 'NYLZ SERVICES',
        // copyright会自动使用当前年份
        copyright: `© ${new Date().getFullYear()} LONGSHANG 保有所有权利`,
    ...
    AUTH_CONFIG: {
        ...
        popup: {
            ...
            // 弹窗内容 (支持HTML)
            content: "<p><strong>欢迎使用我们的服务！</strong></br> 本站仅提供良好的网络使用环境，请勿用于任何非法用途，否则后果自负且不提供退款保障，请妥善保管您的账号信息，如有任何问题请前往 TG 群联系咨询。</p>",
    ...
    AUTH_LAYOUT_CONFIG: {
        ...
        splitLayout: {
            ...
            leftContent: {
                ...
                backgroundImage: 'https://api.sretna.cn/api/scenic.php',
    ...
    GLOBAL_BACKGROUND_CONFIG: {
        enabled: true,
        imageUrl: 'https://api.sretna.cn/api/scenic.php',
        position: 'center',
        size: 'cover',
        repeat: 'no-repeat',
        attachment: 'fixed'
